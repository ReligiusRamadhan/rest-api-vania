...
class ProductsController extends Controller {
  ...
  Future<Response> index() async {
    try {
      ...
      return Response.json(
          {'message': 'Gagal mendapatkan data produk.', 'error': e.toString()},
          500);
    }
  }
  ...
  Future<Response> store(Request request) async {
    try {
      ...
      if (e is ValidationException) {
        print(
            'Validation Errors: ${e.message}'); // Menampilkan pesan error validasi
        return Response.json(
            {'message': 'Gagal membuat produk.', 'error': e.message}, 400);
      }

      print("Error creating product: $e");
      return Response.json(
          {'message': 'Gagal membuat produk.', 'error': e.toString()}, 500);
    }
  }
  ...
  Future<Response> update(Request request, int id) async {
    try {
      ...
      return Response.json(
          {'message': 'Gagal memperbarui produk.', 'error': e.toString()}, 500);
    }
  }
  ...
  Future<Response> destroy(int id) async {
    try {
      ...
      return Response.json(
          {'message': 'Gagal menghapus produk.', 'error': e.toString()}, 500);
    }
  }
}
