...
class ProductNotesController extends Controller {
  ...
  Future<Response> store(Request request) async {
    try {
      ...
      if (e is ValidationException) {
        ...
        return Response.json(
            {'message': 'Gagal membuat catatan produk.', 'error': e.message},
            400);
      }

      print("Error creating product note: $e");
      return Response.json(
          {'message': 'Gagal membuat catatan produk.', 'error': e.toString()},
          500);
    }
  }
  ...
  Future<Response> destroy(int id) async {
    try {
      ...
      return Response.json(
          {'message': 'Gagal menghapus catatan produk.', 'error': e.toString()},
          500);
    }
  }
}
