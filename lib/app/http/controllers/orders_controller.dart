...
class OrdersController extends Controller {
  Future<Response> index() async {
    try {
      ...
      return Response.json(
          {'message': 'Gagal mendapatkan data pesanan.', 'error': e.toString()},
          500);
    }
  }
  ...
  Future<Response> store(Request request) async {
    try {
      ...
      if (e is ValidationException) {
        ...
        return Response.json(
            {'message': 'Gagal membuat pesanan.', 'error': e.message}, 400);
      }
      return Response.json(
  ...
  Future<Response> update(Request request, int id) async {
    try {
      ...
      return Response.json(
          {'message': 'Gagal memperbarui pesanan.', 'error': e.toString()},
          500);
    }
  }
  ...
  Future<Response> destroy(int id) async {
    try {
      ...
      return Response.json(
          {'message': 'Gagal menghapus pesanan.', 'error': e.toString()}, 500);
    }
  }
}
