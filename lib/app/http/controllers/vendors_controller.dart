...
class VendorsController extends Controller {
  ...
  Future<Response> index() async {
    try {
      ...
      return Response.json(
          {'message': 'Gagal mendapatkan data vendor.', 'error': e.toString()},
          500);
    }
  }
  ...
  Future<Response> store(Request request) async {
    try {
      ...
      if (e is ValidationException) {
        ...
        return Response.json(
            {'message': 'Gagal membuat vendor.', 'error': e.message}, 400);
      }

      print("Error creating vendor: $e");
      return Response.json(
          {'message': 'Gagal membuat vendor.', 'error': e.toString()}, 500);
    }
  }
  ...
  Future<Response> update(Request request, int id) async {
    try {
      ...
      return Response.json(
          {'message': 'Gagal memperbarui vendor.', 'error': e.toString()}, 500);
    }
  }
  ...
  Future<Response> destroy(int id) async {
    try {
      ...
      return Response.json(
          {'message': 'Gagal menghapus vendor.', 'error': e.toString()}, 500);
    }
  }
}
